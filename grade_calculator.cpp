...
int main() {
   ...
   //exam variables needed:
    ...
    reading = total_read_score / num_reading_scores;
    engagement = total_engage_score / num_engage_scores;
    ...
    if(reading > 85.0 && reading < 100.0){
        double point_tracker = 0.0;
        point_tracker = 100.0 - reading; //find points that will make the score 100
    ...
    if(engagement > 85.0 && engagement < 100.0){
        double point_tracker2 = 0;
        point_tracker2 = 100.0 - engagement;
   ...
   //grades classified as A-B-C-D-F in certain ranges of points earned
    if(weighted_total >= 90.0){ //if total points is greater than 90 user gets an A
        final_letter_grade = 'A';
    }
    if(weighted_total >= 80.0 && weighted_total < 90.0){
         final_letter_grade = 'B'; //if total points is in between 80 - 89.9 user gets B
     }
    if(weighted_total >= 70.0 && weighted_total < 80.0){
         final_letter_grade = 'C';
     }

    if(weighted_total >= 60.0 && weighted_total < 70.0){
